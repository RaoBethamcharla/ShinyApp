...
shinyUI(
  navbarPage("Shiny Application",
             ...
             tabPanel("Check the Source Files",
                      h2("All the source files can be find in Coursera Data Science section"),
                      hr(),
                      h3(" Peer Assessment"),
             ...
             tabPanel("Go back to my Github repository",
                      a("https://github.com/RaoBethamcharla/ShinyApp"),
                      hr(),
                      h2("You can find the code for ui.R and server.R at my github repositoy ShinyApp.")
             )
  )
)